					...
					<div style="margin-top: -10px;" class="body table-responsive">
						...
						<table class='table table-hover table-striped table-offset'>
							...
							while(($count < $rpp) && ($i < $tcount)) {
								...
								?>
								<tr>
									<td style="vertical-align: middle;"><span class="label label-rounded bg-green"><?php echo $data['username'];?></span></td>
									<td style="vertical-align: middle;"><?php echo $data['full_name'];?></td>
