            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="<?php if (strpos($page, 'dashboard') !== false) {echo 'active';} else { echo 'noactive'; }?>">
                     ...
                     <li class="<?php if (strpos($page, 'menu') !== false) {echo 'active';} else { echo 'noactive'; }?>">
                        <a href="menu.php">
                            <i class="material-icons">burst_mode</i>
                            <span><?php echo $menu_tab; ?></span>
                        </a>
                    </li>
                    ...
                    <li class="<?php if (strpos($page, 'wallpaper.php') !== false || strpos($page, 'wallpaper-') !== false) {echo 'active';} else { echo 'noactive'; }?>">
                        <a href="wallpaper.php">
                            <i class="material-icons">landscape</i>
                            <span><?php echo $menu_wallpaper; ?></span>
                        </a>
                    </li>

                    <li class="<?php if (strpos($page, 'live.php') !== false || strpos($page, 'live-') !== false) {echo 'active';} else { echo 'noactive'; }?>">
                        <a href="live.php">
                            <i class="material-icons">play_circle_filled</i>
                            <span><?php echo $menu_live_wallpaper; ?></span>
                        </a>
                    </li>

                    <li class="<?php if (strpos($page, 'featured') !== false) {echo 'active';} else { echo 'noactive'; }?>">
                        <a href="featured.php">
                    ...
                    <li class="<?php if (strpos($page, 'admin.php') !== false || strpos($page, 'admin-') !== false) {echo 'active';} else { echo 'noactive'; }?>">
                        <a href="admin.php">
